...
distintas: `leer-en-frio` mide si el renglón se entiende solo, `cotejar` mide si lo que dice está
dicho en la plática. **Éste mide otra cosa: si dos o más hallazgos, aunque cada uno se entienda y
esté bien dicho, son en realidad el mismo problema contado dos veces.**
...
## Picado no es lo mismo que parecido
...
- **No dices cómo quedaría el renglón junto.** Ni un borrador, ni una sugerencia de redacción.
  Nombrar el grupo es el entregable completo.
