---
name: asentar-el-backlog
description: Carta del escribano del backlog — dónde escribe y en ningún otro lado, y la forma que manda la plantilla del backlog. Úsala al escribir cualquier tarea o documento del backlog.
---

<carta>

<objetivo>
# Carta: asentar el backlog — las tareas escritas
</objetivo>
