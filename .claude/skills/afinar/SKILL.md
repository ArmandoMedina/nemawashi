...
- **De dónde salió** — el caso **contado**, no su apodo. Ver abajo: es donde más se falla.
- **Qué tan firme:**
  - `dicho` — lo dijo y nadie lo revisó.
  - `confirmado` — se lo devolvieron y dijo que sí.
...
Un apodo es una etiqueta que sólo abre quien vivió el caso: *«el pleito de la tercera falla»*, *«la
pregunta 2»*, *«el caso del molino trabado»*, *«otra red lo cachó»*. Quien no estuvo no tiene dónde
buscar eso — la ronda de preguntas no quedó en ningún archivo, y el pleito tampoco.

Contarlo es decir **qué pasó, con qué se toparon y qué se decidió**:

> Mal: *«El pleito de la tercera falla.»*
> Bien: *«Al molino sólo le entra el resumen que redacta el consultor, no lo que se dijo. Si él
> filtra o suaviza algo, no queda contra qué compararlo. Salió al pelearse por cuál de las tres
> fallas de la corrida era la de fondo.»*

**La prueba, y es de una línea:** si tu renglón nombra algo que no está escrito en ningún archivo
del repositorio, está apodado.

**No lo recortes para que quepa.** El ítem tiene un tope de letras y el caso completo va a rebasarlo
